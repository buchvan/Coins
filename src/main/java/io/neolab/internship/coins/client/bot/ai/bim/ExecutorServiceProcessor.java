...
public class ExecutorServiceProcessor {
    public static final long TIMEOUT_MILLIS = Long.MAX_VALUE; //TODO: если делать параллельный прогон нескольких игр,
    //TODO то стоит данное значение намного увеличить
