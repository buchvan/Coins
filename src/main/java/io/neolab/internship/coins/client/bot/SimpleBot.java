...
//        if (SmartBot.tree != null) {
        final DeclineRaceAction action =
                (DeclineRaceAction) RandomGenerator.chooseItemFromList(
                        Objects.requireNonNull(SmartBot.tree).getEdges()).getAction();
        final boolean choice = Objects.requireNonNull(action).isDeclineRace();
...
//        if (SmartBot.tree != null) {
        final CatchCellAction action =
                (CatchCellAction) RandomGenerator.chooseItemFromList(
                        Objects.requireNonNull(SmartBot.tree).getEdges()).getAction();
        final Pair<Position, List<Unit>> resolution = Objects.requireNonNull(action).getResolution();
        SmartBot.tree = AIProcessor.updateTree(SmartBot.tree, action);
...
//        if (SmartBot.tree != null) {
        final DistributionUnitsAction action =
                (DistributionUnitsAction) RandomGenerator.chooseItemFromList(
                        Objects.requireNonNull(SmartBot.tree).getEdges()).getAction();
        final Map<Position, List<Unit>> distributionUnits = Objects.requireNonNull(action).getResolutions();
        SmartBot.tree = AIProcessor.updateTree(SmartBot.tree, action);
