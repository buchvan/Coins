...
public class GameLoopProcessor {
     ...
     */
    public static List<Cell> getBoardEdgeGetCells(final IBoard board) {
     ...
     * @param board            - борда
     */
    public static void login(final Player player, final Cell targetCell, final List<Cell> neighboringCells,
